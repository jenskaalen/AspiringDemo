...
namespace AspiringDemo
{
    public class GameFrame
    {
        ...
        private static void Init()
        {
            ...
            RuntimeTypeModel.Default.Add(typeof(FactionUnits), true).Add("Units");
            ...
            RuntimeTypeModel.Default.Add(typeof(ActionResult), true).Add("KilledTarget");
            ...
            RuntimeTypeModel.Default.Add(typeof(NeutralFaction), true).Add("CreateUnit","Relations","Areas","FactionManager","CapitalZone","Taxes","IsComputer","Name","Power","Wealth","StructurePoints","ID","Army","Strength","FactionUnits");
            ...
            RuntimeTypeModel.Default.Add(typeof(SerializedGame), true);
            ...
            RuntimeTypeModel.Default.Add(typeof(ActionApplied), true).Add("Method","Target","_target","_methodBase","_methodPtr","_methodPtrAux");
            ...
            RuntimeTypeModel.Default.Add(typeof(FollowOrder), true).Add("FollowTarget","IsPlayerNearby","Unit","OrderName","IsExecuting","IsDone","Finish");
            ...
            RuntimeTypeModel.Default.Add(typeof(FactionPreference), true).Add("ObjectType","SerializedData");
            ...
            //RuntimeTypeModel.Default.Add(typeof(IPathfinder`1), true).Add("Nodes");
            RuntimeTypeModel.Default.Add(typeof(NodeState), true);
            //RuntimeTypeModel.Default.Add(typeof(Pathfinder`1), true).Add("OpenList","ClosedList","Nodes");
