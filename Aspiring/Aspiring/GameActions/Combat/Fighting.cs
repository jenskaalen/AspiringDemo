...
namespace AspiringDemo.GameActions.Combat
{
    ...
    public class Fighting : CompositeAction
    {
        ...
        public override void Update(float elapsed)
        {
            ...
            if (_unit.CombatModule.CurrentTarget == null || _unit.CombatModule.CurrentTarget.CombatModule.CurrentFight == _fight)
            {
                var targets = _unit.CombatModule.GetPotentialTargets(_fight.Units);
